...
import feedbackFortune from "~/assets/img/guides/feedback-fortune-guide.png";
import surveyMistakes from "~/assets/img/guides/survey-mistakes-guide.png";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Download our comprehensive guides and e-books to master survey
            analysis, AI-powered insights, and data-driven decision making. Get
            expert knowledge delivered straight to your inbox.
          </p>
        </div>
          ...
          {guides.map((guide) => (
            ...
            >
              ...
              <div className="h-48 flex items-center justify-center">
                <img src={guide.coverImage} style={{ height: "inherit" }} />
              </div>
              <div className="p-6">
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
            <div className="bg-white rounded-xl max-w-md w-full p-6">
              ...
              <div className="mt-4 text-xs text-slate-500 text-center">
                By downloading, you agree to receive our newsletter with tips
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-slate-600 text-sm">
                Written by industry experts with years of experience in data
                analysis
              </p>
            </div>
            <div>
