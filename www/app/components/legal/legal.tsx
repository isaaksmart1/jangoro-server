export function LegalSnippet() {
  return (
    <div className="flex flex-col flex-wrap w-10/12 md:w-2/5 m-8 p-8 border-2 border-slate-400 rounded-xl">
      <h1 className="text-3xl">Jangoro's Legal Page</h1>
      <Legal />
    </div>
  );
}
  ...
  return (
    <div className="p-4 text-slate-900">
      <p className="text-md my-2">
        Welcome to Jangoro's Legal Information Page. Jangoro is your premier
      ...
      <p className="text-md my-2">
        ...
        rights and responsibilities while using Jangoro. If you have any
