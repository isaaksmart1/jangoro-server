...
const getGuideDetails = (guideId) => {
    const guides = {
        "survey-mistakes-guide": {
            ...
            description: "Learn the common pitfalls small businesses make when conducting and analysing surveys. Perfect for researchers, marketers, and business analysts.",
